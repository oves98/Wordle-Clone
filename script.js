...
function handleKeyPress(e) {
  ...
  if (e.key === "Shift" || e.key == "Tab" || e.key == "Alt" || e.key == "CapsLock" || e.key == "Control" || e.key == "Meta" 
      || e.key == "ArrowLeft" || e.key == "ArrowUp" || e.key == "ArrowDown" || e.key == "ArrowRight"
      || e.key == "NumLock" || e.key == "End" || e.key == "PageUp" || e.key == "PageDown"
      || e.key == "ScrollLock" || e.key == "Pause" || e.key == "Home" || e.key == "Insert" || e.key == "Escape" 
